### Description: Convert a gtf file to a bed file. One transcript per line.
### Adapted from: https://github.com/signalbash/how_are_we_stranded_here/blob/master/how_are_we_stranded_here/gtf2bed.py
import numpy as np
import argparse
