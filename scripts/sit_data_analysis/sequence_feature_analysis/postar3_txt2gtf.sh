...
INPUT_FILE="$POSTAR3_DIR/mouse.txt"
RBP_NAME_LIST="$POSTAR3_DIR/mouse.rbp_with_clip.txt"
OUTPUT_FILE="$POSTAR3_DIR/mouse.gtf"
...
bedtools sort -i "$OUTPUT_FILE" > "$(dirname "$OUTPUT_FILE")/$(basename "$OUTPUT_FILE" .gtf).sorted.gtf"