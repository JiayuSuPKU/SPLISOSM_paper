...
* Raw and processed spatial transcriptomics (ST) data with isoform-level quantification results used in this study can be downloaded from [10.5281/zenodo.15556390 (DOI)](https://zenodo.org/records/15556390). See [data/README.md](data/README.md) for detailed dataset and sample description.
